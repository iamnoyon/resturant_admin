...
import { useCreateWaiterOrderMutation } from "@/store/admin/order";
...
const WaiterOrder = () => {
  ...
  const [createOrder, { isLoading: orderLoading }] = useCreateWaiterOrderMutation();
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-lg font-semibold text-[#043570]">Waiter Order</h2>
        <Link
          href="/waiter-order/list"
