            ...
            <div className="absolute inset-0 flex items-center justify-center p-4 mt-12">
                <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl p-4">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            className={`w-full bg-[#042A55] hover:bg-[#063C76] disabled:bg-blue-500 text-white font-bold py-2.5 rounded-lg transition duration-200 transform hover:scale-101 hover:cursor-pointer active:scale-95 mt-4 flex items-center justify-center`}
                        >
                            ...
                            {isLoading && (
                                ...
                                >
                                    ...
                                    <path
                                        ...
                                        fill="currentColor"
                                        d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.047 1.136 5.824 3 7.938l3-2.647z"
                                    />
                                </svg>
                            )}
                        </button>
